...
export class LayoutComponent implements OnInit, OnDestroy {
    ...
    public modals$!: Observable<ModalComponentData[]>
    ...
    constructor(
        ...
        private _MowConfigService: MowConfigService,
     ...
     */
    ngOnInit(): void {
        // Disabilito il loading automatico
        this._fuseLoadingService.setAutoMode(false)

        // Set the theme and scheme based on the configuration
        combineLatest([
            this._MowConfigService.config$,
