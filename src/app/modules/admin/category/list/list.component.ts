...
export class CategoryListComponent extends BaseListComponent implements OnInit, OnDestroy {
    /**
     * Constructor
     */
    constructor(
        ...
        this.baseService = _categoryService
        this.titolo = 'Category'
        this.tableKey = 'master_category_table'
    }
